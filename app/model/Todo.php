...
class Goal {
  ...
  public static function goal_findAll() {
    ...
    $stmh = $pdo->query("SELECT goals.id, goals.goal, goals.completed_at, goals.created_at, goals.updated_at, goals.deleted_at, goals.user_id FROM goals g, users u WHERE g.user_id = users.id");
